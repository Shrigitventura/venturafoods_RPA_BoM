...
inventory_model_data[-1:-6, ] -> inventory_model_data
...
Open_Cust_Ord <- read.xlsx("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/02042025/US and CAN OO BT where status _ J.xlsx", colNames = FALSE)
...
canada_micro <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/02042025/Canada Open Orders.xlsx", col_names = FALSE)
...
jde_bom_us <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/02042025/jde_us.xlsx", col_names = FALSE)
...
file.copy("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/BOM/01.28.2025/JDE BoM 01.28.2025.xlsx", 
